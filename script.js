...
const Entries = {
  ...
  renderEntryDetails(entry) {
    ...
    if (entry.invoiceMessage) {
      html += `<div style="margin-bottom: 12px; padding: 8px 12px; background: #f7f7f7; border-radius: 16px; font-size: 0.85rem; color: var(--color-graphite);"><strong>Message:</strong> ${escapeHtml(entry.invoiceMessage)}</div>`;
    }
